...
\begin{enumerate}[label=\S \arabic*.]
    ...
    \item A exclusão de um membro poderá ser aplicada pela Diretoria Executiva, garantido o direito à ampla defesa, nos seguintes casos:
          \begin{enumerate}[label=\alph*)]
              ...
              \item Deixar de cumprir, sem justificativa, com as obrigações assumidas junto à Liga por período superior a 2 (dois) meses.
          \end{enumerate}
    \item A exclusão durante um semestre de um Membro Efetivo, sem cargo na Diretoria, acarretará na perda das horas comprometidas à Liga do semestre de desligamento, mantendo-se aquelas anteriores ao semestre, se houverem.
    \item A exclusão durante um semestre de um Membro Efetivo, com cargo na Diretoria, acarretará na perda das horas comprometidas à Liga de todo o mandato no qual teve o cargo, mantendo-se as horas cumpridas fora do cargo.
\end{enumerate}
...
\begin{enumerate}[label=\S \arabic*.]
    \item A Diretoria Executiva é o órgão de administração da Liga, sendo composta por: Presidente(a), Vice-Presidente(a) e Diretores(as) de Área.
...
\begin{enumerate}[label=\S \arabic*.]
    \item As atividades da Liga serão organizadas em Áreas de Atuação, podendo cada qual possuir um ou mais Coordenadores, designados pelo(a) respectivo(a) Diretor(a) de Área.
    \item As áreas, na feitura desse presente estatuto, são:
          \begin{enumerate}[label=\alph*)]
          ...
          \end{enumerate}
    \item As áreas anteriormente listadas são passíveis de alteração de nomenclatura, subdivisão ou remoção, mediante (incluindo criação de novas áreas) aprovação de maioria em Assembleia com quórum de, no mínimo, metade da membros totais da Liga.
\end{enumerate}
...
\begin{enumerate}[label=\S \arabic*.]
    ...
    \item O candidato à eleição para cargo de Diretoria deve possuir 2 (dois) ou mais semestres letivos de permanência na Liga, excetuando-se candidatos a cargos de Secretariado.
\end{enumerate}
